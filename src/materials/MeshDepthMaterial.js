...
class MeshDepthMaterial extends Material {
  ...
  /**
   * 复制另一个MeshDepthMaterial的属性到当前材质。
   * Copy properties from another MeshDepthMaterial to this material.
   *
   * @param {MeshDepthMaterial} source - 要复制属性的源材质
   * @returns {MeshDepthMaterial} 返回当前材质实例，支持链式调用
   */
  copy(source) {
    // 调用父类的copy方法
    super.copy(source);
